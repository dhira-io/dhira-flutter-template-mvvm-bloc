...
class _$TodoEntityImpl implements _TodoEntity {
  ...
  @override
  String toString() {
    return 'TodoEntity(id: $id, title: $title, description: $description, createdAt: $createdAt, isCompleted: $isCompleted)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, title, description, createdAt, isCompleted);
