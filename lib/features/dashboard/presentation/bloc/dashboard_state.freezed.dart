...
class _$DashboardLoadedImpl implements DashboardLoaded {
  const _$DashboardLoadedImpl(final List<TodoEntity> todos) : _todos = todos;
  ...
  @override
  String toString() {
    return 'DashboardState.loaded(todos: $todos)';
  }
...
abstract class DashboardLoaded implements DashboardState {
  const factory DashboardLoaded(final List<TodoEntity> todos) =
